...
const TokenDeployNode = ({ data, isConnectable }: SolanaNodeProps) => (
...
const TransferNode = ({ data, isConnectable }: SolanaNodeProps) => (
  <Card className="min-w-[300px] bg-white dark:bg-gray-800 shadow-lg">
    <Handle type="target" position={Position.Top} isConnectable={isConnectable} />
    <CardHeader>
      <CardTitle className="flex items-center text-sm font-medium">
...
const BalanceNode = ({ data, isConnectable }: SolanaNodeProps) => (
  <Card className="min-w-[300px] bg-white dark:bg-gray-800 shadow-lg">
    <Handle type="target" position={Position.Top} isConnectable={isConnectable} />
    <CardHeader>
      <CardTitle className="flex items-center text-sm font-medium">
...
const NFTCollectionNode = ({ data, isConnectable }: SolanaNodeProps) => (
  <Card className="min-w-[300px] bg-white dark:bg-gray-800 shadow-lg">
    <Handle type="target" position={Position.Top} isConnectable={isConnectable} />
    <CardHeader>
      <CardTitle className="flex items-center text-sm font-medium">
...
const ZKAirdropNode = ({ data, isConnectable }: SolanaNodeProps) => (
  <Card className="min-w-[300px] bg-white dark:bg-gray-800 shadow-lg">
    <Handle type="target" position={Position.Top} isConnectable={isConnectable} />
    <CardHeader>
      <CardTitle className="flex items-center text-sm font-medium">
...
const NFTMintNode = ({ data, isConnectable }: SolanaNodeProps) => (
    <Card className="min-w-[300px] bg-white dark:bg-gray-800 shadow-lg">
      <Handle type="target" position={Position.Top} isConnectable={isConnectable} />
      <CardHeader>
        <CardTitle className="flex items-center text-sm font-medium">
...
const NFTListingNode = ({ data, isConnectable }: SolanaNodeProps) => (
<Card className="min-w-[300px] bg-white dark:bg-gray-800 shadow-lg">
    <Handle type="target" position={Position.Top} isConnectable={isConnectable} />
    <CardHeader>
    <CardTitle className="flex items-center text-sm font-medium">
...
const MetadataNode = ({ data, isConnectable }: SolanaNodeProps) => (
<Card className="min-w-[300px] bg-white dark:bg-gray-800 shadow-lg">
    <Handle type="target" position={Position.Top} isConnectable={isConnectable} />
    <CardHeader>
    <CardTitle className="flex items-center text-sm font-medium">
...
// DeFi & Trading Nodes
const JupiterSwapNode = ({ data, isConnectable }: SolanaNodeProps) => (
<Card className="min-w-[300px] bg-white dark:bg-gray-800 shadow-lg">
    <Handle type="target" position={Position.Top} isConnectable={isConnectable} />
    <CardHeader>
    <CardTitle className="flex items-center text-sm font-medium">
...
const RaydiumNode = ({ data, isConnectable }: SolanaNodeProps) => (
<Card className="min-w-[300px] bg-white dark:bg-gray-800 shadow-lg">
<Handle type="target" position={Position.Top} isConnectable={isConnectable} />
<CardHeader>
    <CardTitle className="flex items-center text-sm font-medium">
...
const OrcaNode = ({ data, isConnectable }: SolanaNodeProps) => (
<Card className="min-w-[300px] bg-white dark:bg-gray-800 shadow-lg">
    <Handle type="target" position={Position.Top} isConnectable={isConnectable} />
    <CardHeader>
    <CardTitle className="flex items-center text-sm font-medium">
...
const LimitOrderNode = ({ data, isConnectable }: SolanaNodeProps) => (
<Card className="min-w-[300px] bg-white dark:bg-gray-800 shadow-lg">
    <Handle type="target" position={Position.Top} isConnectable={isConnectable} />
    <CardHeader>
    <CardTitle className="flex items-center text-sm font-medium">
...
const OracleNode = ({ data, isConnectable }: SolanaNodeProps) => (
<Card className="min-w-[300px] bg-white dark:bg-gray-800 shadow-lg">
    <Handle type="target" position={Position.Top} isConnectable={isConnectable} />
    <CardHeader>
    <CardTitle className="flex items-center text-sm font-medium">
...
const DriftNode = ({ data, isConnectable }: SolanaNodeProps) => (
<Card className="min-w-[300px] bg-white dark:bg-gray-800 shadow-lg">
    <Handle type="target" position={Position.Top} isConnectable={isConnectable} />
    <CardHeader>
    <CardTitle className="flex items-center text-sm font-medium">
...
const WorkTaskNode = ({ data, isConnectable }: SolanaNodeProps) => (
<Card className="min-w-[300px] bg-white dark:bg-gray-800 shadow-lg">
    <Handle type="target" position={Position.Top} isConnectable={isConnectable} />
    <CardHeader>
    <CardTitle className="flex items-center text-sm font-medium">
...
const SNSNode = ({ data, isConnectable }: SolanaNodeProps) => (
<Card className="min-w-[300px] bg-white dark:bg-gray-800 shadow-lg">
    <Handle type="target" position={Position.Top} isConnectable={isConnectable} />
    <CardHeader>
    <CardTitle className="flex items-center text-sm font-medium">
...
const StakingNode = ({ data, isConnectable }: SolanaNodeProps) => (
  <Card className="min-w-[300px] bg-white dark:bg-gray-800 shadow-lg">
    <Handle type="target" position={Position.Top} isConnectable={isConnectable} />
    <CardHeader>
      <CardTitle className="flex items-center text-sm font-medium">
...
export const createSolanaNode = (toolId: string, position: { x: number; y: number }) => {
  const nodeConfig = {
